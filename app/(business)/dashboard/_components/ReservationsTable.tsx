...
export const ReservationsTable = ({ reservations, updateStatus }: Props) => {
      ...
      <TableBody>
        {reservations.map((reservation) => (
          <TableRow key={reservation.id}>
            ...
            <TableCell className="text-center">{reservation.status}</TableCell>
            <TableCell className="text-center">
              <ReservationDialog updateStatus={updateStatus} />
            </TableCell>
