...
export const Header = ({ userId, role }: Props) => {
  ...
  return (
    <header className="bg-white sticky top-0 z-20 transition-all duration-300 w-full shadow-md">
      <div className="w-container">
        <div className="header-inner flex items-center justify-between py-[12px] px-[20px] sm:py-[20px]">
          <Link href={"/"}>
